...
import { InputField, Button } from './Input/index.jsx';
import { TextBox } from './Output/index.jsx'; // Importing TextBox component to display output
...
export const App = () => {
  ...
  const [shoppingList, setShoppingList] = useState<string[]>([]); //we've define a list that can we set the value of
